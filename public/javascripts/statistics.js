  $(document).ready(function(){
    ...
    var sliders = ['relationslider', 'regionslider', 'debtslider', 'transactionslider'];
    sliders.forEach(function(sliderName) {
      ...
      var updateSliderInfo = function(sliderValue) {
        ...
        sliderInfo.text(start.format(dateFormat) + ' - ' + end.format(dateFormat) + ' (' + (endMonth-startMonth+1) + ' Monate)');
      };
