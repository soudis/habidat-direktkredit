...
&nbsp;
  cookies.set(accessTokenCookieConfig.name, passwordGrantAuthenticationResult.accessToken, {
    ...
    secure: (accessTokenCookieConfig.secure === null ? isSecureRequest : <span class="branch-1 cbranch-no" title="branch not covered" >accessTokenCookieConfig.secure)</span>
  });
&nbsp;
  cookies.set(refreshTokenCookieConfig.name, passwordGrantAuthenticationResult.refreshToken, {
    ...
    secure: (refreshTokenCookieConfig.secure === null ? isSecureRequest : <span class="branch-1 cbranch-no" title="branch not covered" >refreshTokenCookieConfig.secure)</span>
  });
};
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Dec 18 2015 16:36:09 GMT-0800 (PST)
</div>
</div>
